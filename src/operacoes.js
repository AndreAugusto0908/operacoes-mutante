...
function clamp(valor, min, max) {
  // Stryker disable next-line EqualityOperator: valor === min retorna o mesmo resultado com < ou <=.
  if (valor < min) return min;
  // Stryker disable next-line EqualityOperator: valor === max retorna o mesmo resultado com > ou >=.
